...
/*
This enum is based off data in the reference_codes table. It has been hard-coded rather than looked up
 ...
 */
enum class ScheduleEnum(val code: String, val description: String) {
