...
interface OffenceScheduleMappingRepository : JpaRepository<OffenceScheduleMapping, Long> {
  ...
  fun deleteByScheduleParagraphIdAndOffenceId(scheduleParagraphId: Long, offenceId: Long)
  fun findOneByScheduleParagraphIdAndOffenceId(scheduleParagraphId: Long, offenceId: Long): Optional<OffenceScheduleMapping>
}
