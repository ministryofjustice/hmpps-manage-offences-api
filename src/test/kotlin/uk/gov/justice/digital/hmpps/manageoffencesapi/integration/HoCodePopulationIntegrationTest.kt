...
class HoCodePopulationIntegrationTest : IntegrationTestBase() {
  ...
  @Test
  fun `should get tables with no data`() {
    val hoCodeWeightings = riskActuarialHoCodeCategoryRepository.findAll()
    assertThat(hoCodeWeightings).isEmpty()
  }
...
//    assertThat(hoCodeCategory.map { it.weightingName })
